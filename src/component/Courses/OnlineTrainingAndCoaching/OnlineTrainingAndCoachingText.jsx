...
const OnlineTrainingAndCoachingText = () => {
  return (
    <div>
     ...
     lg:absolute lg:right-30 lg:top-[230px]">
      <div className="text-left px-4 md:mx-[43%] lg:w-[600px]">
        ...
        <h1 className="text-4xl uppercase -my-6 text-white font-bold mb-2  md:text-4xl md:-mx-11 text-left">
...
export default OnlineTrainingAndCoachingText
