...
const HomeHeroText = () => {
  return (
    <div className="container absolute -my-[50%] lg:-my-[7%] md:-my-[0%] md:labsolute md:top-0 lg:absolute lg:right-96 lg:top-[300px]">
      <div className="text-left px-4 md:mx-[35%] w-[1000px]">

        <h1 className="text-xl text-white font-semibold mb-2 md:text-5xl lg:text-xl">
  CHETHAN <span className="bg-gradient-to-r from-amber-400 to-amber-700 bg-clip-text text-transparent">FILM SCHOOL</span>
</h1>
        <h1 className="text-xl text-white font-semibold mb-2 md:text-5xl lg:text-8xl">
